...
import type NodejsSynchronousAdapter from './http/adapters/NodejsSynchronousAdapter';
import type Session from './Session';
import type {GraphVersion, RequestMethod, RequestParams} from './http/Request';

export type AbstractHttpAdapter = NodejsSynchronousAdapter;
...
class Api {
  ...
  constructor(http_adapter: AbstractHttpAdapter, session: Session, graph_version: GraphVersion): void {
